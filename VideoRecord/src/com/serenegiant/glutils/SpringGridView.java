...
public class SpringGridView extends GridView {
    ...
    public SpringGridView(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        mReleaseBackAnimDuration = DEF_RELEASE_BACK_ANIM_DURATION;//a.getInt(R.styleable.SpringListView_slv_releaseBackAnimDuration, DEF_RELEASE_BACK_ANIM_DURATION);
        mFlingBackAnimDuration = DEF_FLING_BACK_ANIM_DURATION;//a.getInt(R.styleable.SpringListView_slv_flingBackAnimDuration, DEF_FLING_BACK_ANIM_DURATION);
        mEnableSpringEffectWhenDrag = true;//a.getBoolean(R.styleable.SpringListView_slv_enableSpringEffectWhenDrag, true);
        mEnableSpringEffectWhenFling = true;//a.getBoolean(R.styleable.SpringListView_slv_enableSpringEffectWhenFling, true);
        //a.recycle();
